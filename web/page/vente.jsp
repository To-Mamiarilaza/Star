...
<%@page contentType="text/html" pageEncoding="UTF-8" import="java.util.Vector, table.HistVenteLibelle, table.*, recette.Recette"%>
<% 
    Vector<HistVenteLibelle> historiques = Stock.getHistoriqueVente();
...
<body>
    <div class="container">
        <h1>STAR : <span>Vente</span></h1><br>
        <form class="formulaire form" method="post" action="validerVente.jsp">
            <div class="mb-3">
            ...
            <table class="table">
                ...
                <% for(int i = 0; i < historiques.size(); i++) {    %>
                    <tr>
                        <td><% out.print(historiques.get(i).getDateVente()); %></td>
